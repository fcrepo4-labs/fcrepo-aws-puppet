...
### Put your AWS credentials in the file: ~/.awssecret, in the form:
...
### Update the EC2 configuration elements found in ./fcrepo-aws-puppet/cloud-init/create-ec2-instance.conf
